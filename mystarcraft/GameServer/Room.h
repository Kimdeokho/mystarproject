...
public:
	...
	inline const WCHAR*		GetTitle(VOID){CThreadSync Sync;return mTitle;}
	inline VOID				SetTitle(const WCHAR* title){CThreadSync Sync; wcsncpy_s(mTitle ,_countof(mTitle), title , _countof(mTitle) - 1);}
