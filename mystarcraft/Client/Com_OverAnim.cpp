...
CCom_OverAnim::CCom_OverAnim(D3DXMATRIX& objmat)
:CCom_Animation(objmat)
{
	m_objname = L"OVERLOAD";
	m_statkey = L"";
}

CCom_OverAnim::~CCom_OverAnim(void)
{
}

void CCom_OverAnim::Initialize(CObj* pobj)
{
	m_battack_end = true;
...
void CCom_OverAnim::Update(void)
{
...
void CCom_OverAnim::Render(void)
{
...
void CCom_OverAnim::SetAnimation(const TCHAR* statekey)
{
...
void CCom_OverAnim::Release(void)
{
