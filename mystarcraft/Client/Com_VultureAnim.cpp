...
#include "TimeMgr.h"
#include "Obj.h"
CCom_VultureAnim::CCom_VultureAnim(D3DXMATRIX& objmat)
...
CCom_VultureAnim::~CCom_VultureAnim(void)
{
}

void CCom_VultureAnim::Initialize(CObj* pobj)
{
	m_battack_end = true;
...
void CCom_VultureAnim::SetAnimation(const TCHAR* statekey)
{
...
void CCom_VultureAnim::Update(void)
{
...
void CCom_VultureAnim::Render(void)
{
	m_objshadow_mat = m_objmat;
	m_objshadow_mat._42 += 8;

	m_pSprite->SetTransform(&m_objshadow_mat);
	m_pSprite->Draw(m_curtex->pTexture , NULL , &D3DXVECTOR3( 50.f , 50.f , 0)
...
void CCom_VultureAnim::Release(void)
{
