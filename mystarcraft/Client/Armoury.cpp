...
void CArmoury::Update_Wireframe(void)
{
	...
	if(true == m_upg_info[UPG_T_MECHANIC_WEAPON].proceeding && m_upg_info[UPG_T_MECHANIC_WEAPON].obj_num == m_obj_id)
		CComanderMgr::GetInstance()->SetProduction_info(D3DXVECTOR2(interface_pos.x + 293 , interface_pos.y + 435) , m_upg_info[UPG_T_MECHANIC_WEAPON].curtime / m_upg_info[UPG_T_MECHANIC_WEAPON].maxtime );
	else if(true == m_upg_info[UPG_T_MECHANIC_ARMOR].proceeding && m_upg_info[UPG_T_MECHANIC_ARMOR].obj_num == m_obj_id)
		CComanderMgr::GetInstance()->SetProduction_info(D3DXVECTOR2(interface_pos.x + 293 , interface_pos.y + 435) , m_upg_info[UPG_T_MECHANIC_ARMOR].curtime / m_upg_info[UPG_T_MECHANIC_ARMOR].maxtime );
	else if(true == m_upg_info[UPG_T_AIR_WEAPON].proceeding && m_upg_info[UPG_T_AIR_WEAPON].obj_num == m_obj_id)
		CComanderMgr::GetInstance()->SetProduction_info(D3DXVECTOR2(interface_pos.x + 293 , interface_pos.y + 435) , m_upg_info[UPG_T_AIR_WEAPON].curtime / m_upg_info[UPG_T_AIR_WEAPON].maxtime );
	else if(true == m_upg_info[UPG_T_AIR_ARMOR].proceeding && m_upg_info[UPG_T_AIR_ARMOR].obj_num == m_obj_id)
		CComanderMgr::GetInstance()->SetProduction_info(D3DXVECTOR2(interface_pos.x + 293 , interface_pos.y + 435) , m_upg_info[UPG_T_AIR_ARMOR].curtime / m_upg_info[UPG_T_AIR_ARMOR].maxtime );
}