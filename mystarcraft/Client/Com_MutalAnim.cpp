...
CCom_MutalAnim::CCom_MutalAnim(D3DXMATRIX& objmat)
...
CCom_MutalAnim::~CCom_MutalAnim(void)
{
}

void CCom_MutalAnim::Initialize(CObj* pobj)
{
	m_battack_end = true;
...
void CCom_MutalAnim::Update(void)
{
...
void CCom_MutalAnim::Render(void)
{
...
void CCom_MutalAnim::SetAnimation(const TCHAR* statekey)
{
...
void CCom_MutalAnim::Release(void)
{
