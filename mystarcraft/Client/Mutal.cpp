...
void CMutal::Initialize(void)
{
	...
	m_vertex.right = 22.f;
	m_vertex.top =  22.f;
	m_vertex.bottom = 22.f;

	m_com_anim = new CCom_MutalAnim(m_matWorld);
...
void CMutal::Inputkey_reaction(const int& nkey)
{
...
void CMutal::Inputkey_reaction(const int& firstkey , const int& secondkey)
{
...
bool CMutal::Input_cmd(const int& firstkey , const int& secondkey)
{
	return false;
}

void CMutal::Update_Cmdbtn(void)
{
...
void CMutal::Update_Wireframe(void)
{
...
void CMutal::SetDamage(const int& idamage , DAMAGE_TYPE edamagetype)
{
