...
CCom_ZerglingAnim::CCom_ZerglingAnim(D3DXMATRIX& objmat )
:CCom_Animation(objmat )
{
	m_objname = L"ZERGLING";
	m_statkey = L"";
}

CCom_ZerglingAnim::~CCom_ZerglingAnim(void)
{
}

void CCom_ZerglingAnim::Initialize(CObj* pobj)
{
...
void CCom_ZerglingAnim::Update(void)
{
...
void CCom_ZerglingAnim::Render(void)
{
	if(NULL == m_curtex)
		return;
...
void CCom_ZerglingAnim::SetAnimation(const TCHAR* statekey)
{
...
void CCom_ZerglingAnim::Release(void)
{
