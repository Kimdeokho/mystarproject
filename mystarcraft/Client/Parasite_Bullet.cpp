...
CParasite_Bullet::CParasite_Bullet(TEAM_NUMBER eteam , const int& ptarget_id , const D3DXVECTOR2& vdesetpos)
{
	m_ptarget = NULL;
...
CParasite_Bullet::~CParasite_Bullet(void)
{
	Release();
}
void CParasite_Bullet::Initialize(void)
{
...
void CParasite_Bullet::Update(void)
{
...
void CParasite_Bullet::Render(void)
{
...
void CParasite_Bullet::Dead(void)
{
}

void CParasite_Bullet::Release(void)
{
