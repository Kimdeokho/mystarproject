...
void CBattle_addon::Update_Wireframe(void)
{
	...
	if(true == m_upg_info[UPG_T_VIP0].proceeding && m_upg_info[UPG_T_VIP0].obj_num == m_obj_id)
		CIngame_UIMgr::GetInstance()->SetProduction_info(D3DXVECTOR2(interface_pos.x + 293 , interface_pos.y + 435) , m_upg_info[UPG_T_VIP0].curtime / m_upg_info[UPG_T_VIP0].maxtime );
